...
Run Tools/app_store_release.sh --preflight 2.0 608 locally. Once the record and signing assets exist, use --upload to archive, export, and upload through Xcode.
